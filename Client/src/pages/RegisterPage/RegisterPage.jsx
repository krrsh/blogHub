  ...
  return (
    <div className="signup_formContainer">
      ...
      <div className="termsCheckBox">
        ...
        <p>
          By creating an account, I agree to our <span>Terms of use</span> and{" "}
      ...
      <p className="haveaccnt">
        Already have an account?{" "}
        <span onClick={() => navigate("/loginPage")}>Login</span>
      </p>
      <p className="terms">
        This site is protected by and the <span>Google Privacy Policy</span> and{" "}
